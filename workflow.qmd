...
> Github](https://www.linkedin.com/learning-login/share?account=2153100&forceAccount=false&redirect=https%3A%2F%2Fwww.linkedin.com%2Flearning%2Flearning-git-and-github-14213624%3Ftrk%3Dshare_ent_url%26shareId%3DMbR%252FIb35SFSq%252BWIOnc2cxQ%253D%253D)
...
documents. Many examples of my work are available written in R Markdown. This
includes things like the [textbook for CE
361](https://byu-transpolab.github.io/ceen361/) and a [number of my academic
...
A newer technology called Quarto somewhat easier to work with, and can process
code written in R, python, or any number of other languages. There is a
...
> repository](https://github.com/byu-transpolab/template_bookdown) that
> generates a bookdown website and Elsevier journal article. I hope to create a
> similar template for Quarto in the near future.
>
> Using the [cosmodown](https://github.com/gregmacfarlane/cosmodown) package,
> you can set up a template to make your BYU Engineering thesis in bookdown. A
> Quarto template may come soon.
>
