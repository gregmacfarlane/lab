...
documents. Many examples of my work are available written in R Markdown or Quarto. This
...
A newer technology called Quarto is somewhat easier to work with, and can process
...
> repository](https://github.com/byu-transpolab/template_quarto) that
> generates a bookdown website and Elsevier journal article. 
>
> Using the [byu-thesis](https://github.com/gregmacfarlane/byu-thesis) quarto extention,
> you can set up a template to make your BYU Engineering thesis in quarto. 
>
