...
BYU has given you free access to unlimited space on Box. I may create a folder that you use for a project, or you might create a folder and invite me to it. Folders should be organized with the same `data/` `README`, etc. file structure as described in [R Projects](#sec-r-projects).
...
R Markdown and Quarto are technologies for embedding analysis code inside of documents. Many examples of my work are available written in R Markdown. This includes things like the [textbook for CE 361](https://byu-transpolab.github.io/ceen361/) and a [number of my academic papers](https://byu-transpolab.github.io/alameda_destinationchoice/). One set of source documents can be used to create a website, a word document, and a journal-formatted PDF file.

A newer technology called Quarto somewhat easier to work with, and can process code written in R, python, or any number of other languages. There is a comprehensive [authoring guide to Quarto](https://quarto.org/docs/guide/); read this guide and refer to it.

> I have written a [template GitHub repository](https://github.com/byu-transpolab/template_bookdown) that generates a bookdown website and Elsevier journal article. I hope to create a similar template for Quarto in the near future.
>
> Using the [cosmodown](https://github.com/gregmacfarlane/cosmodown) package, you can set up a template to make your BYU Engineering thesis in bookdown. A Quarto template may come soon.
>
> A linkedin Learning Course, [Creating Reports and Presentations with R Markdown and RStudio](https://www.linkedin.com/learning-login/share?account=2153100&forceAccount=false&redirect=https%3A%2F%2Fwww.linkedin.com%2Flearning%2Fcreating-reports-and-presentations-with-r-markdown-and-rstudio%3Ftrk%3Dshare_ent_url%26shareId%3D5bTcMu4SRjeGWItf4ZRuOQ%253D%253D) will help you learn these techniques.
...
The Box code must be the link for the direct download. Please [see the Box manual](https://support.box.com/hc/en-us/articles/360043697554-Configuring-Individual-Shared-Link-Settings) for instructions on creating and using this link.
